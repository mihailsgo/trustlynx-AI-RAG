---
id: 10-05-cannot-get-into-the-portal
title: "\"Application server is not available\" and other access problems"
summary: >
  A full-screen message meaning the pad cannot reach the system behind it. It retries every
  ten seconds by itself and has a Retry Now button. Not something a signer can fix, and no
  signed document is at risk.
...
images:
  - file: images/screen-server-offline.png
    caption: images/screen-server-offline.md
