---
id: 06-02-prerequisites-at-evaluation-level
title: What do we need in place to run PadSign?
summary: >
  A host with a container runtime, roughly 4 CPUs and 6-8 GB RAM, a hostname you
  control, a TLS certificate for it, disk space that grows with your document volume,
  and outbound access to whichever external services your signature level needs. Plus
  a touchscreen device with a browser.
section: deployment
audience: [prospect]
answer_style: direct
keywords:
...
do_not_state:
  ...
  - Anything about the default exposure of individual services, firewalling specifics, or how the entry point could be bypassed.
