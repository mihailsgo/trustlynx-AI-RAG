---
id: 04-01-two-things-that-happen-when-you-sign
title: Two different things happen when you sign
summary: >
  Your drawn mark is placed into the page as a picture. Separately, a
  cryptographic seal can be applied to the whole file. They are different
  mechanisms with different weight, and the seal is the part that makes the file
  tamper-evident.
...
disclaimer: >
  This explains how the mechanisms work, not what legal effect they have in your
  situation. Legal standing depends on the certificate and timestamp authority the
  operating organisation chose, and on the jurisdiction. Confirm with TrustLynx and
  your own legal advisers before relying on it.
do_not_state:
