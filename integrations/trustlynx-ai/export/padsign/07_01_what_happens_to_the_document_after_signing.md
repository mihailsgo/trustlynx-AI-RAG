---
doc_id: padsign_07_01_what_happens_to_the_document_after_signing
source_path: padsign/07_01_what_happens_to_the_document_after_signing.md
source_type: markdown
title: What happens to the document after I sign it?
language: en
audience:
  - public
product: padsign_2_0
...
tags:
  ...
  - prospect
summary: >-
  It is stored as a completed version, sealed if your organisation uses sealing, and handed onward
  automatically. Then the pad clears itself. Nothing is lost when the screen resets, and the signer
  does not have to save or send anything.
extra:
  kb_chunk_id: 07-01-what-happens-to-the-document-after-signing
  kb_audience:
    - end-user
    - prospect
  answer_style: direct
...
- What happens to the document after I sign?
- Is it saved automatically?
- Do I need to do anything after signing?
- The screen reset, did my document get saved?
- Will I get a copy?

*Related terms: what happens next, do i need to save, automatically saved, where does it go.*
