---
doc_id: padsign_08_02_virtual_printer_user_journey
source_path: padsign/08_02_virtual_printer_user_journey.md
...
tags:
  ...
  - end-user
summary: >-
  Open the document, print it to the "Padsign" printer, the customer signs on the pad, and the
  signed PDF appears back in a folder on your computer. Four steps, no new application to learn.
extra:
  kb_chunk_id: 08-02-virtual-printer-user-journey
  kb_audience:
    - end-user
...
*Related terms: how to send a document, print to padsign, print for signature, send to tablet, my workflow, staff instructions.*
