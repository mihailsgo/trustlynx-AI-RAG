---
doc_id: padsign_01_05_padsign_and_the_trustlynx_product_family
source_path: padsign/01_05_padsign_and_the_trustlynx_product_family.md
...
tags:
  ...
  - prospect
summary: >-
  PadSign is for in-person signing on a touchscreen. SignBox collects signatures from remote,
  invited people. The API Platform and Connectors embed signing into your own systems, the
  Authentication Service handles digital identities, and the e-Sealing service seals documents.
  Which one fits depends on where your signer is.
extra:
  kb_chunk_id: 01-05-padsign-and-the-trustlynx-product-family
  kb_audience:
    - prospect
  answer_style: direct
  confidence: verified
...
*Related terms: padsign vs signbox, product family, which product, api platform, connectors, authentication service, e-sealing, comparison, which one do we need.*
