---
doc_id: padsign_07_03_getting_the_signed_pdf_back_to_the_sending_computer
source_path: padsign/07_03_getting_the_signed_pdf_back_to_the_sending_computer.md
...
tags:
  ...
  - prospect
summary: >-
  A document sent from a Windows desktop can have the signed version returned to that same desktop
  automatically. It waits until collected, so a PC that is switched off or offline loses nothing.
extra:
  kb_chunk_id: 07-03-getting-the-signed-pdf-back-to-the-sending-computer
  kb_audience:
    - end-user
    - prospect
  answer_style: direct
...
*Related terms: signed copy, desktop, receive back, collect, offline pc, virtual printer, where did it go.*
