---
doc_id: padsign_fig_screen_signer_name_label
source_path: padsign/figures/screen_signer_name_label.md
source_type: markdown
title: 'Screen: The signature box with a Signer name label displayed above it'
language: en
audience:
  - public
product: padsign_2_0
...
tags:
  ...
  - screenshot
  - end-user
summary: The signature box with a Signer name label displayed above it.
extra:
  kb_image_id: screen-signer-name-label
  used_by:
