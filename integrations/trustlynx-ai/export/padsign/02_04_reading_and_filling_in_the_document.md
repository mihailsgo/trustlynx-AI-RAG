---
doc_id: padsign_02_04_reading_and_filling_in_the_document
source_path: padsign/02_04_reading_and_filling_in_the_document.md
source_type: markdown
title: Reading the document and filling in its fields
language: en
audience:
  - public
product: padsign_2_0
...
tags:
  ...
  - end-user
summary: >-
  Scroll the PDF to read it, then tap any highlighted field and type into it. Nothing is submitted
  while you do this. If a required field is missed you are told before anything is sent.
extra:
  kb_chunk_id: 02-04-reading-and-filling-in-the-document
  kb_audience:
    - end-user
...
- How do I scroll the document?
- Can I zoom in on the document?
- Which fields do I have to fill in?
- Can I type with the on-screen keyboard?
- What if I miss a field?

*Related terms: form fields, read document, required field, mandatory, checkbox, highlighted.*
